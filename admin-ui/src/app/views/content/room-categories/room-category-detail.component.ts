...
import {AdminApiCategoryApiClient,RoomCategoryDto} from './../../../api/admin-api.service.generated'
...
export class RoomCategoryDetailComponent implements OnInit, OnDestroy {
    ...
    selectedEntity = {} as RoomCategoryDto;
    ...
    constructor(
        ...
        private postCategoryService: AdminApiCategoryApiClient,
    ...
    loadDetail(id: any) {
        ...
        this.postCategoryService.getRoomCategoryId(id)
            .pipe(takeUntil(this.ngUnsubscribe))
            .subscribe({
                next: (response: RoomCategoryDto) => {
    ...
    private saveData() {
        if (this.utilService.isEmpty(this.config.data?.id)) {
            this.postCategoryService.createRoomCategory(this.form.value)
                .pipe(takeUntil(this.ngUnsubscribe))
                .subscribe(() => {
            ...
            this.postCategoryService.updateRoomCategory(this.config.data.id, this.form.value)
                .pipe(takeUntil(this.ngUnsubscribe))
                .subscribe(() => {
                    this.toggleBlockUI(false);
                    this.ref.close(this.form.value);
