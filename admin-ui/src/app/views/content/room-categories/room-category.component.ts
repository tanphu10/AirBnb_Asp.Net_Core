...
export class RoomCategoryComponent implements OnInit, OnDestroy {
  ...
  //Business variables
  public items: RoomCategoryDto[] | undefined;
  public selectedItems: RoomCategoryDto[] = [];
  public keyword: string = '';

  constructor(
    private roomCategoryService: AdminApiCategoryApiClient,
  ...
  loadData() {
    ...
    this.roomCategoryService
      .getRoomCategoryPaging(this.keyword, this.pageIndex, this.pageSize)
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe({
        next: (response: RoomCategoryDtoPagedResult) => {
  ...
  showAddModal() {
    const ref = this.dialogService.open(RoomCategoryDetailComponent, {
  ...
  deleteItemsConfirm(ids: any[]) {
    ...
    this.roomCategoryService.deleteRoomCategory(ids).subscribe({
      next: () => {
