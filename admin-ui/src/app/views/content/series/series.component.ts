...
import { SeriesRoomsComponent } from './series-room.component';
import { MessageConstants } from '../../../shared/constants/message.constant';
import {AdminApiSeriesApiClient,RoomInListDtoPagedResult, SeriesDto, SeriesInListDto} from './../../../api/admin-api.service.generated'
...
export class SeriesComponent implements OnInit, OnDestroy {
  ...
  showPosts() {
    ...
    var id = this.selectedItems[0].id;
    const ref = this.dialogService.open(SeriesRoomsComponent, {
      data: {
        id: id
      },
